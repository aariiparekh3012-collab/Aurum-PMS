...
const styles = StyleSheet.create({
  ...
  avatarText: { ...font.bold, fontSize: 22, color: colors.primary },
  ...
  nomineeRank: { ...font.bold, fontSize: 16, color: colors.primary, width: 30 },
  nomineeName: { ...font.medium, fontSize: 14, color: colors.text },
  nomineeRel: { ...font.regular, fontSize: 12, color: colors.muted, marginTop: 2 },
  nomineeShare: { ...font.semibold, fontSize: 14, color: colors.primary },
